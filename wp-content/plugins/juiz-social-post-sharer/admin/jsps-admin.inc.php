...
function juiz_sps_activation() {
	...
	if ( ! is_array( $juiz_sps_options ) ) {
		...
		if ( ! isset( $juiz_sps_options['juiz_sps_version'] ) ) {
			...
			$juiz_sps_options['juiz_sps_networks']['tumblr'] 	= array( 0, 'Tumblr' );
			$juiz_sps_options['juiz_sps_networks']['delicious'] = array( 0, 'Delicious' );
			$juiz_sps_options['juiz_sps_networks']['reddit'] 	= array( 0, 'Reddit' );
...
function juiz_sps_sanitize( $options ) {
	...
	if ( is_array( $options['juiz_sps_networks'] ) ) {
		...
		if ( ! in_array( 'tumblr', $juiz_sps_opt['juiz_sps_networks'] ) ) {
			$juiz_sps_opt['juiz_sps_networks']['tumblr'] = array( 0, 'Tumblr' );
			$juiz_sps_opt['juiz_sps_networks']['delicious'] = array( 0, 'Delicious' );
			$juiz_sps_opt['juiz_sps_networks']['reddit'] = array( 0, 'Reddit' );
		}
