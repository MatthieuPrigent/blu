...
function athemes_scripts() {
	...
	wp_enqueue_script( 'Waves', get_template_directory_uri() . '/js/waves.min.js', array( 'jquery' ) );
...
function athemes_footer_credits() {
	...
	<div class="site-credit">
		<a href="/espace-partenaires">Partenaires</a>
	</div><!-- .site-credit -->
	<?php
}
 ...
 * Ajoute un champ personnalisé par défaut (chapo)
...
function wpc_champs_personnalises_defaut($post_id)
{
    if ( $_GET['post_type'] != 'page' ) {
        add_post_meta($post_id, 'Chapo', '', true);
    }
    return true;
}
