...
<form name="loginform" id="loginform" action="<?php echo esc_url( wp_login_url() ); ?>" method="post">
	...
	?>
	<p class="forgetmenot"><label for="rememberme"> <?php esc_attr_e('Remember Me'); ?></label><input name="rememberme" type="checkbox" id="rememberme" value="forever" <?php checked( $rememberme ); ?> /></p>
	<p class="submit">
